...
(function () {
  ...
  window.PAGE_CONFIG = {
    ...
    pages: [{
      ...
      labels: [{
        label: '房源曝光',
        texts: '发布房源，让所有经纪人能找到你和你的房源'
      }, {
        label: '智能海报',
        texts: '随时更新房源信息，自动生成推广海报'
      }, {
        label: '推广分析',
        texts: '追踪推广效果，找出市场推广盲点'
      }],
      others: "<em class=\"u-icon u-arrow j-arrow g-pa\"></em>"
    }, {
      type: 'blue',
      ...
      labels: [{
        label: '房源搜索',
        texts: '免费搜索全市场真实房源，直联业主招商'
      }, {
        label: '方案制作',
        texts: '快速生成房源方案，第一时间推给客户'
      }, {
        label: '客户管理',
        texts: '追踪客户看房动态，深入了解客户需求'
      }],
      others: "<em class=\"u-icon u-arrow j-arrow g-pa\"></em>"
    }, {
      type: 'white',
      ...
      labels: [{
        label: '了解市场',
        texts: '快速了解租赁市场，租约谈判心中有数'
      }, {
        label: '优质服务',
        texts: '发现优质服务商，设计装修不再踩坑'
      }, {
        label: '房源收藏',
        texts: '收藏心动房源，轻松对比选择'
      }],
      ...
      title: '楼澜愿景',
      subTitle: '楼澜专注搭建一个开放透明、真实高效的办公房源平台，构建行业的数字化基础设施，通过科技和数据提升办公场景的效率、体验和价值，助推办公场景面向未来的变革。',
      otherTitles: "<p class=\"u-p2 g-fs28 g-mt60\">Email\uFF1A</p>\n                <p class=\"u-p2 g-fs28 g-mt20\">\u5BA2\u670D\u90AE\u7BB1\uFF1A<a s-cr_white href=\"mailto:".concat(EMAILS.service, "\">").concat(EMAILS.service, "</a><br/>\n                    \u5546\u52A1\u5408\u4F5C\uFF1A<a s-cr_white href=\"mailto:").concat(EMAILS.cooperation, "\">").concat(EMAILS.cooperation, "</a></p>\n                <p class=\"u-p2\"><img src=\"./public/i-qrcode.png\" class=\"qr-code g-mt60\" alt=\"\u697C\u6F9C\u5C0F\u7A0B\u5E8F\u4E8C\u7EF4\u7801\"/></p>")
    }]
  };
})();